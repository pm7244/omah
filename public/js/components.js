...
function initComponents({
	...
	// Initialize carousels on every page load and PJAX transition
	// This ensures carousel event listeners are re-attached
	if (typeof InitializeCarousels !== 'undefined') {
		InitializeCarousels();
	}
