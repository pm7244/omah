  ...
  return (
    <Fragment>
      ...
      <aside
        ...
        onMouseOut={() => Outhover()}
      >
        <div className="main-sidebar-header" style={{ padding: '1rem', display: 'flex', alignItems: 'center', justifyContent: 'center', borderBottom: '1px solid #e5e7eb' }}>
          <Link
            to={`${import.meta.env.BASE_URL}/cmsdashboards/sales/`}
          ...
          >
            <img
              ...
              style={{ height: '100px', width: 'auto', objectFit: 'contain', maxWidth: '100%' }}
            />
            <img
              src={ALLImages("omahLogo")}
              alt="Omah Logo"
              ...
              {menuitems.map((firstlayer) => (
                <React.Fragment key={Math.random()}>
                  {firstlayer.menutitle ? (
                    <li className="slide__category">{firstlayer.menutitle}</li>
                  ) : (
                    ""
                  )}
