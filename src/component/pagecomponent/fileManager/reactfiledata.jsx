...
export const Filemanagerlistdata = [
  {
    ...
    class3: "",
    class2:
      "hs-dropdown ti-dropdown  absolute top-0 ltr:right-0 rtl:left-0 block text-gray-500 dark:text-white/70 text-xs",
    class1:
      "absolute top-0 ltr:left-0 rtl:right-0 block text-gray-500 dark:text-white/70 text-xs",
    class: "",
    typeoffile: "File.pdf",
    filesize: "20MB",
    client1: jpg64,
  ...
  },
  {
    ...
    class4: "text-warning",
    viewer: card3,
    class3: "sm:h-[146px] w-full",
    class2:
      "hs-dropdown ti-dropdown  absolute top-5 ltr:right-5 rtl:left-5 block text-gray-500 dark:text-white/70 text-xs",
    class1:
      "absolute top-5 ltr:left-5 rtl:right-5 block text-gray-500 dark:text-white/70 text-xs",
    class: "p-0",
    typeoffile: "Hillstation.jpg",
    filesize: "30MB",
    client1: jpg64,
    client2: jpg58,
  },
