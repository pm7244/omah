...
import ProjectsCatTable from "./ProjectsCatTable";

const ProjectsCategory = () => {
  return (
    <div>
      <PageHeader
        currentpage="Sub-category & Project"
        activepage="Pages"
        mainpage="Sub-category & Project"
      />
      <div className="box">
        <div className="p-3">
          <div className="grid grid-cols-12 gap-6">
            <div className="col-span-12 lg:col-span-4">
              <div className="sm:flex sm:space-x-3 sm:space-y-0 space-y-1 task-left rtl:space-x-reverse">
                <Link
                  to={`/cms/pages/sub_categoryid/addsub_categoryid`}
                  className="ti-btn ti-btn-primary"
                >
                  <i className="ri-add-line"></i>
                  Add New Sub-category & Project
                </Link>
              </div>
            </div>
            ...
            <div className="col-span-12">
              <div className="box xl:overflow-auto">
                <div className="box-header">
                  <h5 className="box-title">Sub-category & Project List</h5>
                </div>
                <div className="box-body">
